          ...
          <div className="grid items-stretch gap-7 md:grid-cols-[1fr_auto_1fr]">
            <div className="rounded-[3px] bg-bg p-9 text-paper">
              ...
              <div className="text-sm leading-relaxed opacity-80">
                Per month — 20 meals at ~₦6,000 each, delivery included, via typical
                food-delivery apps.
              </div>
            </div>
            ...
            <div className="rounded-[3px] bg-paprika p-9 text-ink">
              ...
              <div className="text-sm leading-relaxed opacity-80">
                Per month — the same 20 meals, freezer-ready, delivered on your schedule.
              </div>
            </div>
          </div>
          <div className="mt-7 flex flex-wrap items-center gap-4 font-mono text-sm text-paprika-dim">
            <span className="font-serif text-[22px] font-semibold text-ink">₦75,000 saved</span>
            <span>— that&apos;s 62% back in your pocket, every single month.</span>
          </div>
        </div>
      </section>
